...
function emailCheck(email){
		...
		wr = window.open(url,"email중복확인","width=500,height=300");
	...
	<div class="container">
		...
		<form action="update" class="form-horizontal" method="post" 
			...
			<div class="form-group">
				...
				<div class="col-sm-6">
					<input type="text" class="form-control" 
						name="address1" id="sample6_address" value="${dto.address1 }">
					<input type="text" class="form-control" 
						name="address2" id="sample6_detailAddress" value="${dto.address2 }">
				</div>
			</div>
			<div class="form-group">
