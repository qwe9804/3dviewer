			...
			<div id="mast-body">
				...
				<div id="infoDiv" style="">
					<div class="container">
								...
								<div class="col-md">
									<div class="form-wrap __normal __x1">
										<div class="ui-input">
											...
											<button type="button" id="mChkBtn" name="mbutton" onclick="money"
									...
									<div class="form-wrap __phone">
										...
										<div class="ui-input">
											<input type="tel" id="cellphoneNo2" name="cellphoneNo2"
												value="${dto.m_phone1 }" readonly="readonly" title="전화번호 가운데 자리"> 
										</div>
										<div class="ui-input">
											<input type="tel" id="cellphoneNo2" name="cellphoneNo2"
												value="${dto.m_phone2}" readonly="readonly" title="전화번호 가운데 자리"> 
										</div>
										<div class="ui-input">
											<input type="tel" id="cellphoneNo3" name="cellphoneNo3"
												value="${dto.m_phone3}" readonly="readonly" title="전화번호 뒷자리">
										</div>
									</div>
								</div>
							</div>
						...
						onclick="updatemypage">정보수정</button>
						<button type="button" class="ui-button __square-large __blue"
